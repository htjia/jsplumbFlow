...
// 散点图菜单
export function scatterinfo() {
  return JSON.stringify(scatter)
}
// 饼图菜单
...
// 透视表菜单
export function tableinfo1() {
  return JSON.stringify(table1)
}
// 表菜单
export function zuheinfo() {
  return JSON.stringify(zuhe)
}
// 表菜单
export function leidainfo() {
  return JSON.stringify(leida)
}
// 维度条件列表
export function condListx() {
  return JSON.stringify(condList)
}
// 度量条件判断列表
export function condListsx() {
  return JSON.stringify(condLists)
}
// 时间过滤条件列表
export function dataWDListx() {
  return JSON.stringify(dataWDList)
}
// 聚合函数
export function aggregateFunListx() {
  return JSON.stringify(aggregateFunList)
}
// 搜索菜单
export function inputlist() {
  return JSON.stringify(inputli)
}
// 日期搜索格式年月日周
export function dataList() {
  return JSON.stringify(datatypelist)
}
