  ...
  <PageHeaderLayout >
      ...
      <div class="search-box">
        <div class="left-search-box">
          <div class="input-item">
            ...
            <el-select v-model="type" size="small" class="search-input" style="width:105px" placeholder="请选择" clearable>
              <el-option
    ...
    <div class="app-container">
      <el-table
        ...
        <el-table-column label="数据源名称" align="center" min-width="180px" prop="taskCode"/>
        <el-table-column label="数据源类型" align="center" prop="groupName" show-overflow-tooltip/>
        <el-table-column label="链接信息" align="center" prop="typeName" show-overflow-tooltip/>
        <el-table-column label="测试情况" align="center" prop="typeMachineSpec" min-width="80px" show-overflow-tooltip/>
