  ...
  <PageHeaderLayout >
    <div class="header-search-add height-auto" style="padding-top: 0">
      <div class="input-item">
        <span class="input-title">任务名称 </span>
        <el-input v-model="dataName" class="search-input" size="small" placeholder="请输入任务名称" maxlength="20" clearable/>
      </div>
    ...
    <el-dialog
      ...
      <el-form ref="dataForm" :model="dataForm" :rules="rules" status-icon label-width="110px" label-position="right">
        <el-form-item label="任务名称" prop="name">
          <el-input v-model="dataForm.name" type="text" placeholder="请输入任务名称"/>
        </el-form-item>
